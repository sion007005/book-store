...
public class CategoryParser {
    ...
    public void parse(String url) throws IOException {
        ...
        for (Element level2Li : level2LiElements) {
            ...
            String categoryNumber = parseAndSave(level2Li, 2, "001");

            for (Element level3Li : level3LiElements) {
                parseAndSave(level3Li, 3, categoryNumber);
            }
        }
    }

    private String parseAndSave(Element element, int level, String parentCategoryNumber) {
        ...
        log.info("{} {} {} {} {} ", level, categoryName, categoryLink, categoryNumber, parentCategoryNumber);
